<?php
// plugins/termos/front/editar_radio.php
...
Html::header(__('Editar Rádio', 'termos'), $_SERVER['PHP_SELF'], 'plugins', 'termos');
...
echo "<td width='30%'><label><span style='color: red;'>*</span> ".__('Fabricante', 'termos')."</label></td>";
echo "<td>";
...
// Modelo
echo "<tr class='tab_bg_1'>";
echo "<td><label>".__('Modelo', 'termos')."</label></td>";
echo "<td>";
...
// Número de Série
echo "<tr class='tab_bg_1'>";
echo "<td><label><span style='color: red;'>*</span> ".__('Número de Série', 'termos')."</label></td>";
echo "<td>";
...
// Patrimônio
echo "<tr class='tab_bg_1'>";
echo "<td><label>".__('Patrimônio', 'termos')."</label></td>";
echo "<td>";
...
// Chave NF
echo "<tr class='tab_bg_1'>";
echo "<td><label>".__('Chave da Nota Fiscal', 'termos')."</label></td>";
echo "<td>";
...
// Status - CORRIGIDO
echo "<tr class='tab_bg_1'>";
echo "<td width='30%'><label>".__('Status', 'termos')."</label></td>";
echo "<td>";
...
echo "<tr class='tab_bg_1'>";
echo "<td><label>".__('Localização', 'termos')."</label></td>";
echo "<td>";
...
echo "<tr class='tab_bg_1'>";
echo "<td><label>".__('Grupo', 'termos')."</label></td>";
echo "<td>";
...
// Usuário - CORRIGIDO
echo "<tr class='tab_bg_1'>";
echo "<td><label>".__('Usuário', 'termos')."</label></td>";
echo "<td>";
...
// Observações
echo "<tr class='tab_bg_1'>";
echo "<td><label>".__('Observações', 'termos')."</label></td>";
echo "<td>";
echo Html::textarea([
    'name' => 'comment',
...
echo Html::submit(_x('button','💾 Atualizar Rádio', 'termos'), ['name' => 'update_radio', 'class' => 'btn btn-success']);
echo " ";
